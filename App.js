...
const RestaurantCard = (props)=>{
    ...
    const{cloudinaryImageId,name,cuisines,avgRating,costForTwo} = restData?.card?.card?.info;
    ...
    return(
        <div className="body">
            ...
            <div className="res-container">
                {
                  resData1.map(restaurant => (<RestaurantCard key ={restaurant.card.card.info.id} restData={restaurant}/>))
                }
