...
//              alt="res-logo"
//              src= {"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+res1.card.card.info.cloudinaryImageId}/>
//             <h3>{name}</h3>
//             <h4>{cuisines.join(", ")}</h4>
//             <h4>{avgRating}</h4>
//             <h4>{costForTwo}</h4>
...
//                 {
//                   resData1.map(restaurant => (<RestaurantCard key ={restaurant.card.card.info.id} res1={restaurant}/>))
//                 }
